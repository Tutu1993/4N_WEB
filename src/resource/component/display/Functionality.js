require('cssDir/display/functionality.css')

const Functionality = (
	<div className="db-functionality" data-1124="left: 0%;" data-1924="left: -50%;">
		<div className="db-text-box">
			<h2>功能性</h2>
			<div className="db-text-word">
