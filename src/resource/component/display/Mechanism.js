require('cssDir/display/mechanism.css')

const Mechanism = (
	<div className="db-mechanism" data-1124="left: 100%;" data-1924="left: 0%;" data-5324="left: 0%;" data-6124="left: -50%;">
		<div className="db-text-box" data-1124="padding-left: 100%;" data-1924="padding-left: 0%;">
			<h2>机械机构</h2>
			<div className="db-text-word" data-1124="padding-left: 250%;" data-1924="padding-left: 0%;">
				...
				<div className="db-logo" data-1124="padding-left: 500%;" data-1924="padding-left: 0%;">
					<a href="https://twitter.com/4N_PARIS" target="_blank"></a>
					<a href="https://www.facebook.com/4Nwatches" target="_blank"></a>
				</div>
			</div>
		</div>
		<div className="db-m-img" data-1124="padding-left: 300%;" data-1924="padding-left: 0%;">
